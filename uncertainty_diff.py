...
def main():
    ...
    g_preds  = pickle.load(open('ds_after_preds.pkl',       'rb'))
    g_logits = pickle.load(open('ds_after_predictions.pkl', 'rb'))
    g_targs  = pickle.load(open('ds_after_targets.pkl',     'rb'))

    val = load_or_none('val_predictions.pkl')
    if val is not None:
        g_val_preds  = pickle.load(open('val_preds.pkl',       'rb'))
        g_val_logits = pickle.load(open('val_predictions.pkl', 'rb'))
        g_val_targs  = pickle.load(open('val_targets.pkl',     'rb'))
    ...
    evaluate(g_preds, g_logits, g_targs, g_thresh, "Density-Softmax")
